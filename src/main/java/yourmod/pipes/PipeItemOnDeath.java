...
public class PipeItemOnDeath extends PipeRegexNamed<Item> {
    public static final PRNPart PREF = new PRNPref("deathdata");

    public PipeItemOnDeath() {
    ...
    private Item makeInternal(HeroType ht) {
        ...
        OnDeathEffect startOfCombat = new OnDeathEffect(new EffBill(e));
