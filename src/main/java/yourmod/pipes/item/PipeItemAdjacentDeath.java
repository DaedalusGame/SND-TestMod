...
public class PipeItemAdjacentDeath extends PipeRegexNamed<Item> {
    public static final PRNPart PREF = new PRNPref("deathadjacentdata");

    public PipeItemAdjacentDeath() {
    ...
    private Item makeInternal(HeroType ht) {
        ...
        EffAdjacentsOnDeath startOfCombat = new EffAdjacentsOnDeath(e);
