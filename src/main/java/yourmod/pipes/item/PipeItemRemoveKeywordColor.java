...
public class PipeItemRemoveKeywordColor extends PipeRegexNamed<Item> {
    public static final PRNPart PREF = new PRNPref("rkcol");

    public PipeItemRemoveKeywordColor() {
        super(PREF, HEROCOL);
    }
    ...
    private Item makeInternal(HeroCol col) {
        return new ItBill(-69, PREF + col.shortName()).prs(new RemoveKeywordColour(col.col)).bItem();
    }
